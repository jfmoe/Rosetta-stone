<?php
    ...
    if (authenticate_user()) {
        ...
        if(!isset($_POST['re_id'])) $re_id = 0; else $re_id = $_POST['re_id'];
        $sql = "insert into comments(comment_body,comment_created_time,comment_update_time,article_id_in_comment,commentator_id,reply_id) values(:comment_body,:comment_created_time,:comment_update_time,:article_id_in_comment,:commentator_id,:reply_id);";
        ...
        $query->bindParam(':reply_id', $re_id, PDO::PARAM_INT);
        ...
        if (!$query->execute()) {
            ...
            redirect_to("../articles/show.php?id=" . $_POST['article_id_in_comment'] . "#comment");
        };
    }
