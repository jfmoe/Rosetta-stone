...
<div class="content">
    ...
    <div class="global-nav">
        <ul>
            ...
            <li style="float:right; padding-right: 15px"><a href="<?php if(is_login()) echo "show.php?id=".current_user()->user_id; else echo 'user/index.php'?>"><?php if(is_login()) echo current_user()->nickname;else echo '登录'?></a></li>
        </ul>
    </div>
