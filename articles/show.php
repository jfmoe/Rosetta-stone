...
<div class="content">
    ...
    <div class="the-article" >
        ...
        <div class="footer-sharing">
            ...
            <button id="btn" class="good" value="<?php echo $article->article_id?>">星星</button><span id="result" class="good-number"><?php echo $article->get_stars?></span>
    ...
    <div class="aside-in-articles">
        <div class="mini-userzone">
            ...
            <div class="data-in-miniaside">文章:<?php echo get_number("select * from articles where article_is_delete=0 and author_id=" . $user->user_id)?>篇 &nbsp;&nbsp;星辰:<?php echo get_star_light($user->user_id)?>颗</div>
        </div>
        <div class="articles-in-aside">
            ...
            <?php
                ...
                <div class="new-articles"><a href="show.php?id=<?php echo $article1->article_id?>"><?php echo $article1->title ?></a>&nbsp;(<?= $article1->get_stars?>颗星星)</div>
                <?php  }} ?>
        </div>
        <div class="articles-in-aside">
            ...
            <?php
                ...
                foreach($hot_articles as $value):?>
                    <div class="hot-articles"><a href="show.php?id=<?= $value["article_id"] ?>"><?= $value["title"]?></a><p><?= $value["nickname"]?>&nbsp;<?= $value["get_read"]?>人浏览<p></div>
                <?php  endforeach;?>
        </div>
    </div>
    <--评论-->
